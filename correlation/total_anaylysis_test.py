...
CLASSES = {'类别flat_roof': 0, '类别gable_roof': 0, '类别gambrel_roof': 0, '类别row_roof': 0, '类别multiple_eave_roof': 0,
           ...
           '类别revolved': 0, '类别other': 0,
           'flat_roof面积': 0, 'gable_roof面积': 0, 'gambrel_roof面积': 0, 'row_roof面积': 0, 'multiple_eave_roof面积': 0,
           'hipped_roof_v1面积': 0, 'hipped_roof_v2面积': 0, 'mansard_roof面积': 0, 'pyramid_roof面积': 0, 'arched_roof面积': 0,
           'revolved面积': 0, 'other面积': 0,
           'flat_roof密度': 0, 'gable_roof密度': 0, 'gambrel_roof密度': 0, 'row_roof密度': 0, 'multiple_eave_roof密度': 0,
           'hipped_roof_v1密度': 0, 'hipped_roof_v2密度': 0, 'mansard_roof密度': 0, 'pyramid_roof密度': 0, 'arched_roof密度': 0,
           'revolved密度': 0, 'other密度': 0,
           'flat_roof占比': 0, 'gable_roof占比': 0, 'gambrel_roof占比': 0, 'row_roof占比': 0, 'multiple_eave_roof占比': 0,
           'hipped_roof_v1占比': 0, 'hipped_roof_v2占比': 0, 'mansard_roof占比': 0, 'pyramid_roof占比': 0, 'arched_roof占比': 0,
           'revolved占比': 0, 'other占比': 0,
           'flat_roof比例': 0, 'gable_roof比例': 0, 'gambrel_roof比例': 0, 'row_roof比例': 0, 'multiple_eave_roof比例': 0,
           'hipped_roof_v1比例': 0, 'hipped_roof_v2比例': 0, 'mansard_roof比例': 0, 'pyramid_roof比例': 0, 'arched_roof比例': 0,
           'revolved比例': 0, 'other比例': 0,
           'Low_rise': 0, 'Multi_storey': 0, 'Medium_and_high_rise': 0, 'High_rise_v1': 0, 'High_rise_v2': 0,
           'total_number': 0, 'total_area': 0}

# 用于显示的字典
LABELS_1 = ["flat", "gable", "gambrel", "row", "multi_eave",
            "hipped_v1", "hipped_v2", "mansard", "pyramid", "arched",
            "revolved", "other"]
